const getEmailTemplate = ({ username, date, seat_number }) => {
  ...
  emailTemplate += "  <link href=\"https:\/\/fonts.googleapis.com\/css?family=Lato\" rel=\"stylesheet\" type=\"text\/css\">";
  emailTemplate += "  <!--<![endif]-->";
  emailTemplate += "    ";
  ...
  emailTemplate += "";
  emailTemplate += "    <div style=\"background-color:#424242;\">";
  emailTemplate += "      <div style=\"Margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #424242;\" class=\"block-grid \">";
  emailTemplate += "        <div style=\"border-collapse: collapse;display: table;width: 100%;background-color:#424242;\">";
  emailTemplate += "          <!--[if (mso)|(IE)]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"background-color:#424242;\" align=\"center\"><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"width: 500px;\"><tr class=\"layout-full-width\" style=\"background-color:#424242;\"><![endif]-->";
  emailTemplate += "";
  emailTemplate += "              <!--[if (mso)|(IE)]><td align=\"center\" width=\"500\" style=\" width:500px; padding-right: 0px; padding-left: 0px; padding-top:30px; padding-bottom:30px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;\" valign=\"top\"><![endif]-->";
  ...
  emailTemplate += "              <!--[if (!mso)&(!IE)]><!--><div style=\"border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:30px; padding-bottom:30px; padding-right: 0px; padding-left: 0px;\"><!--<![endif]-->";
  emailTemplate += "";
  emailTemplate += "                  ";
  emailTemplate += "                    <div align=\"center\" class=\"img-container center  autowidth  fullwidth\" style=\"padding-right: 0px;  padding-left: 0px;\">";
  emailTemplate += "<!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 0px; padding-left: 0px;\" align=\"center\"><![endif]-->";
  emailTemplate += "  <img class=\"center  autowidth  fullwidth\" align=\"center\" border=\"0\" src=\"http:\/\/study.vanillacoding.co\/images\/logo_white_text.png\" alt=\"바닐라 스터디\" title=\"바닐라 스터디\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 500px\" width=\"500\">";
  ...
  emailTemplate += "";
  emailTemplate += "                  ";
  emailTemplate += "                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\"><![endif]-->";
  emailTemplate += "<div style=\"color:#555555;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\">  ";
  emailTemplate += "  <div style=\"font-size:12px;line-height:14px;text-align:center;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;\"><p style=\"margin: 0;font-size: 12px;line-height: 14px;text-align: center\"><strong><span style=\"font-size: 20px; line-height: 24px;\">바닐라 스터디 예약 내역<\/span><\/strong><\/p><\/div>  ";
  emailTemplate += "<\/div>";
  emailTemplate += "<!--[if mso]><\/td><\/tr><\/table><![endif]-->";
  emailTemplate += "";
  emailTemplate += "                  ";
  ...
  emailTemplate += "";
  emailTemplate += "                  ";
  emailTemplate += "                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 40px; padding-left: 40px; padding-top: 30px; padding-bottom: 30px;\"><![endif]-->";
  emailTemplate += "<div style=\"color:#555555;line-height:120%;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif; padding-right: 40px; padding-left: 40px; padding-top: 30px; padding-bottom: 30px;\">  ";
  emailTemplate += `  <div style=\"font-size:12px;line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;color:#555555;text-align:left;\"><p style=\"margin: 0;font-size: 12px;line-height: 14px;text-align: center\"><span style=\"font-size: 16px; line-height: 19px;\">예약자: ${username}<\/span><\/p><p style=\"margin: 0;font-size: 12px;line-height: 14px;text-align: center\"><span style=\"font-size: 16px; line-height: 19px;\">예약일: ${date}<\/span><\/p><p style=\"margin: 0;font-size: 12px;line-height: 14px;text-align: center\"><span style=\"font-size: 16px; line-height: 19px;\">예약좌석: ${seat_number}<\/span><\/p><\/div> `;
  emailTemplate += "<\/div>";
  emailTemplate += "<!--[if mso]><\/td><\/tr><\/table><![endif]-->";
  emailTemplate += "";
  emailTemplate += "                  ";
  ...
  emailTemplate += "        <\/div>";
  emailTemplate += "      <\/div>";
  emailTemplate += "    <\/div>    <div style=\"background-image:url('http:\/\/study.vanillacoding.co\/images\/bg_long.png');background-position:top left;background-repeat:no-repeat;;background-color:transparent\">";
  emailTemplate += "      <div style=\"Margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;\" class=\"block-grid \">";
  emailTemplate += "        <div style=\"border-collapse: collapse;display: table;width: 100%;background-color:transparent;\">";
  emailTemplate += "          <!--[if (mso)|(IE)]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"background-image:url('http:\/\/study.vanillacoding.co\/images\/bg_long.png');background-position:top left;background-repeat:no-repeat;;background-color:transparent\" align=\"center\"><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"width: 500px;\"><tr class=\"layout-full-width\" style=\"background-color:transparent;\"><![endif]-->";
  emailTemplate += "";
  emailTemplate += "              <!--[if (mso)|(IE)]><td align=\"center\" width=\"500\" style=\" width:500px; padding-right: 0px; padding-left: 0px; padding-top:25px; padding-bottom:25px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;\" valign=\"top\"><![endif]-->";
  emailTemplate += "            <div class=\"col num12\" style=\"min-width: 320px;max-width: 500px;display: table-cell;vertical-align: top;\">";
  emailTemplate += "              <div style=\"background-color: transparent; width: 100% !important;\">";
  emailTemplate += "              <!--[if (!mso)&(!IE)]><!--><div style=\"border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:25px; padding-bottom:25px; padding-right: 0px; padding-left: 0px;\"><!--<![endif]-->";
  emailTemplate += "";
  emailTemplate += "                  ";
  emailTemplate += "                    &#160;";
  emailTemplate += "                  ";
